...
import 'package:marty_admin/second_page.dart';
...
class MartyAdmin extends StatefulWidget {
  const MartyAdmin({Key? key}) : super(key: key);

  @override
  _MartyAdminState createState() => _MartyAdminState();
}

class _MartyAdminState extends State<MartyAdmin> {
  ...
  void getImages() {
    listOfImage = [];
    for (int i = 1; i <= 5; i++) {
      listOfImage.add(AssetImage('images/shoe' + i.toString() + '.jpg'));
    }
  }
